                        ...
                        <div className="row grid">
                                ...
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f1.png" alt="Delicious Pizza" width={500} height={300} />
                                        </div>
                            ...
                            <div className="col-sm-6 col-lg-4 all burger">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f2.png" alt="Delicious Burger" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            ...
                                            <div className="options">
                                                <h6>$15</h6>
                                                <a href="#">
                                                    <svg viewBox="0 0 456.029 456.029" style={{ enableBackground: 'new 0 0 456.029 456.029' }}>
                                                        <g>
                                                            <path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248c0,29.184,23.552,53.248,53.248,53.248 c29.184,0,53.248-23.552,53.248-53.248C398.336,362.926,374.784,338.862,345.6,338.862z" />
                                                        </g>
                                                        <g>
                            ...
                            <div className="col-sm-6 col-lg-4 all pizza">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f3.png" alt="Delicious Pizza" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            <h5>Delicious Pizza</h5>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-4 all pasta">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f4.png" alt="Delicious Pasta" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                            ...
                            <div className="col-sm-6 col-lg-4 all fries">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f5.png" alt="French Fries" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            <h5>French Fries</h5>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-4 all pizza">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f6.png" alt="Delicious Pizza" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            <h5>Delicious Pizza</h5>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-4 all burger">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f7.png" alt="Tasty Burger" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            <h5>Tasty Burger</h5>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-4 all burger">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f8.png" alt="Tasty Burger" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            <h5>Tasty Burger</h5>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-4 all pasta">
                                <div className="box">
                                    <div>
                                        <div className="img-box">
                                            <Image src="/static/images/f9.png" alt="Delicious Pasta" width={500} height={300} />
                                        </div>
                                        <div className="detail-box">
                                            <h5>Delicious Pasta</h5>
                                            <p>
